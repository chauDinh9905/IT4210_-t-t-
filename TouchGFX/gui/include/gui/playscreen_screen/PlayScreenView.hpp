...
protected:
	...
	static const uint16_t PLAYER_STEP = 12;       // Tốc độ di chuyển
	...
	static const uint8_t BULLET_SPEED = 5; // Tốc độ bay (pixel/frame)
	static const uint8_t FIRE_DELAY_TICKS = 15; // Khoảng cách giữa 2 lần bắn (số frames)
	...
	static const uint8_t SCORE_PER_ENEMY = 2;
